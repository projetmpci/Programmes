...
img = Image.open(
    "/home/maxime/Documents/S2/INFO/ProjetS2/sprites_proj.png")  # Modifier l'adresse pour pouvoir accéder au fichier
print(img)
rendu = Image.open("/home/maxime/Documents/S2/INFO/ProjetS2/Imagevide.png")  # Pareil
