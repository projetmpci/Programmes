...
def verifie_itersection(vecteur_segment_centre, placement_personnage, vecteur_directeur_segment, point_segment):
    ...
    norme_vecteur_segment_centre = ray_x ** 2 + ray_y ** 2
    norme_vecteur_directeur_segment = segm_x ** 2 + segm_y ** 2
    if scalaire_carré == norme_vecteur_directeur_segment * norme_vecteur_segment_centre:
        return True
    else:
